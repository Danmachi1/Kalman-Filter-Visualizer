...
public final class SRUKFWrapper implements AutoCloseable, com.example.filtertest.KalmanFilterModule {

    /* ── customise these two for each variant ─────────────────────────── */
    private static final String LIB_NAME = "kalman_ukf";   // DLL / SO base name
    private static final String PREFIX   = "srukf";          // "srekf", "ukf", "srukf"
